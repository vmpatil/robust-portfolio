...
def true_mean_cov(data, units, T, num_sectors, num_units):
    if data == 'Fama-French':
...
#         # second method
#         grand_mean = np.mean(true_expected_returns)
#         true_expected_returns = (2/3)*true_expected_returns + (1/3)*grand_mean
#         #
...
def Xi_maker(num_sectors, identity, sigma, inv_sigma, power, cov):
